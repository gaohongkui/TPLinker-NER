...
class HandshakingKernel(nn.Module):
    ...
    def forward(self, seq_hiddens):
        ...
        for ind in range(seq_len):
            ...
            shaking_hiddens_list.append(shaking_hiddens) # shaking_hiddens_list里放的是(batch_size,seq_len,hidden_size),(batch_size,seq_len-1,hidden_size),(batch_size,seq_len-2,hidden_size)...(batch_size,1,hidden_size)
